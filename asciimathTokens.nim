...
const AMTokens* = [
  ...
  (symbol:"sum", tex:r"\sum", tkKind:UNDEROVER),
  (symbol:"prod", tex:r"\prod", tkKind:UNDEROVER),
  (symbol:"^^", tex:r"\wedge", tkKind:CONST),
  (symbol:"^^^", tex:r"\bigwedge", tkKind:UNDEROVER),
  (symbol:"vv", tex:r"\vee", tkKind:CONST),
  (symbol:"vvv", tex:r"\bigvee", tkKind:UNDEROVER),
  (symbol:"nn", tex:r"\cap", tkKind:CONST),
  (symbol:"nnn", tex:r"\bigcap", tkKind:UNDEROVER),
  (symbol:"uu", tex:r"\cup", tkKind:CONST),
  (symbol:"uuu", tex:r"\bigcup", tkKind:UNDEROVER),
  ...
  #standard functions
  # (symbol:"lim", tex:r"lim", tkKind:UNDEROVER),
  # (symbol:"Lim", tex:r"Lim", tkKind:UNDEROVER),
  # (symbol:"sin", tex:r"sin", tkKind:UNARY, func:true),
  # (symbol:"cos", tex:r"cos", tkKind:UNARY, func:true),
  # (symbol:"tan", tex:r"tan", tkKind:UNARY, func:true),
  # (symbol:"sinh", tex:r"sinh", tkKind:UNARY, func:true),
  # (symbol:"cosh", tex:r"cosh", tkKind:UNARY, func:true),
  # (symbol:"tanh", tex:r"tanh", tkKind:UNARY, func:true),
  # (symbol:"cot", tex:r"cot", tkKind:UNARY, func:true),
  # (symbol:"sec", tex:r"sec", tkKind:UNARY, func:true),
  # (symbol:"csc", tex:r"csc", tkKind:UNARY, func:true),
  # (symbol:"arcsin", tex:r"arcsin", tkKind:UNARY, func:true),
  # (symbol:"arccos", tex:r"arccos", tkKind:UNARY, func:true),
  # (symbol:"arctan", tex:r"arctan", tkKind:UNARY, func:true),
  # (symbol:"coth", tex:r"coth", tkKind:UNARY, func:true),
  # (symbol:"sech", tex:r"sech", tkKind:UNARY, func:true),
  # (symbol:"csch", tex:r"csch", tkKind:UNARY, func:true),
  # (symbol:"exp", tex:r"exp", tkKind:UNARY, func:true),
  ...
  # (symbol:"log", tex:r"log", tkKind:UNARY, func:true),
  # (symbol:"ln", tex:r"ln", tkKind:UNARY, func:true),
  # (symbol:"det", tex:r"det", tkKind:UNARY, func:true),
  # (symbol:"dim", tex:r"dim", tkKind:CONST),
  # (symbol:"mod", tex:r"mod", tkKind:CONST),
  # (symbol:"gcd", tex:r"gcd", tkKind:UNARY, func:true),
  # (symbol:"lcm", tex:r"lcm", tkKind:UNARY, func:true),
  # (symbol:"lub", tex:r"lub", tkKind:CONST),
  # (symbol:"glb", tex:r"glb", tkKind:CONST),
  # (symbol:"min", tex:r"min", tkKind:UNDEROVER),
  # (symbol:"max", tex:r"max", tkKind:UNDEROVER),
  # (symbol:"Sin", tex:r"Sin", tkKind:UNARY, func:true),
  # (symbol:"Cos", tex:r"Cos", tkKind:UNARY, func:true),
  # (symbol:"Tan", tex:r"Tan", tkKind:UNARY, func:true),
  # (symbol:"Arcsin", tex:r"Arcsin", tkKind:UNARY, func:true),
  ...
  (symbol:"ubrace", tex:r"\underbrace", tkKind:UNARYUNDEROVER),
  (symbol:"obrace", tex:r"\overbrace", tkKind:UNARYUNDEROVER),
